...
public static class AuditDisplayCatalog
{
    private static readonly Dictionary<string, AuditActionDisplay> Actions = new()
    {
        ...
        ["ReferenceProposal.NoNormAdmin"] = new("Нет NormAdmin в организации", AuditSeverity.Warning),
        ["Workflow.NoAssignee"] = new("Нет исполнителя в организации", AuditSeverity.Warning),
