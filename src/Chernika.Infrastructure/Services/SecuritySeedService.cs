...
internal static class RolePermissionDefaults
{
    private static readonly Dictionary<string, string[]> RolePermissions = new()
    {
        ...
        [
            ...
            PermissionCodes.IndividualCardCreateDraft, PermissionCodes.IndividualCardEditDraft,
            PermissionCodes.IndividualCardRecalculateDraft, PermissionCodes.IndividualCardForm,
            PermissionCodes.IndividualCardCreateVersion, PermissionCodes.IndividualCardArchive,
